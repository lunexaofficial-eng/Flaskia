...
export default function OrdersHub({
  ...
  const handlePrintInvoice = async (ord: Order) => {
    ...
    const shipper = ord.shippingDetails || {
      ...
      zip: "02139",
      licenseId: "GUEST-LIC",
      email: "research@rexvora-labs.com",
      address: "",
      country: "",
      phone: ""
    };
    ...
    doc.text("OFFICIAL REXVORA CHEMICAL TRANSACTION RECORD - REGISTERED INVOICE", 18, pageHeight - 11.8);
  ...
  const handlePrintCompliance = async (ord: Order) => {
    ...
    doc.setFontSize(10);
    doc.setFont("helvetica", "normal");
    doc.text("Rexvora Laboratory Material Registry", 14, 28);
    ...
    doc.setFontSize(8);
    doc.text("This document is generated by Rexvora Serverless Dispatch. Do not duplicate.", 14, doc.internal.pageSize.height - 15);
